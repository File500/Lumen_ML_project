...
def predict_monk_skin_types(model_path, csv_path, image_dir, output_csv_path=None, batch_size=32):
    ...
    try:
        ...
        model = AttentionSkinToneClassifier(num_classes=7)
...
MODEL_PATH = os.path.join(PROJECT_PATH, "trained_model", "skin_type_classifier", "EFNet_b3_300X300_test18", "final_model.pth")
